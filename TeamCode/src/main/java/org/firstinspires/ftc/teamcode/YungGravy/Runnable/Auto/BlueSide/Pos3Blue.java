...
@Autonomous(name = "pos3blue", group = "bruh")
public class Pos3Blue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        move.goForward(-2720, 0.6, false);
        //line up against wall ^
        move.goRight(-460, 0.2, false);
        move.leftLetGo();
        sleep(500);
        move.leftUndeployed();
        move.goRight(220, 0.2, false);
        move.goForward(-300, 0.2, false);
        move.goForward(3550, 0.45, false);
        move.goForward(200, 0.2, true);
        move.turn(40, 0.2, false);
        move.leftLineUp();
        sleep(300);
        move.goRight(-150, 0.2, false);
        move.leftGrab();
        sleep(400);
        move.leftKeepIn();
        move.goRight(230, 0.2, false);
        move.goForward(-3200, 0.6, false);
        //^second long move
        move.goRight(-320, 0.2, false);
        move.leftLetGo();
        sleep(500);
        move.leftUndeployed();
