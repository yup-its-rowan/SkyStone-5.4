...
@Autonomous(name = "pos1red", group = "bruh")
public class Pos1Red extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        move.goForward(2550, 0.35, false);
        move.goRight(-220, 0.4, false);
        move.leftLetGo();
        move.reinit();//JIC
        sleep(500);
        ...
        move.splineIsh(2700, 2600, 340, 540,  0.38, 0.38, 0.1, 0.1,  false);
        //move.goForward(700, 0.5, false);
        //move.turn(1050, 0.2, false);
        //move.goRight(-450, 0.2, false);
        move.goForward(-800, 0.3, false);
        move.unTrapPlate();
        sleep(1000);
