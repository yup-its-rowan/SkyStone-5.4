...
@Autonomous(name = "pos3red", group = "bruh")
public class Pos3Red extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        move.goForward(2910, 0.4, false);
        move.goRight(-420, 0.4, false);
        move.leftLetGo();
        move.reinit();//JIC
        sleep(500);
        ...
        move.splineIsh(2700, 2600, 340, 540,  0.41, 0.41, 0.1, 0.1,  false);
