...
public class ActualGyroBot extends OpMode {

    public GyroDrive odoGyro = new GyroDrive();
    ...
    public void loop() {
        ...
        slides.slideInputs(gamepad2.right_trigger, gamepad2.left_trigger, gamepad2.left_bumper, gamepad2.right_bumper, gamepad2.y, telemetry, eTime.time());
